...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:B5471B,50:D99A1C,100:B5471B&height=3&section=header" width="100%" />

## English

### 🍁 A developer who values a finished service built together over flawless code written alone

#### About Me

- 🔭 I design **REST APIs and data models** with Node.js/NestJS & Express.
- 🛡️ I work with **Prisma schema design, JWT Guard-based authorization**, AuditLog, and budget-reservation transactions.
- 👥 Led 3 projects as **team lead** in Codeit Full-stack Cohort 10.
- ⚙️ I build operational environments with **GitHub Actions (CI), E2E testing, AWS EC2 · PM2 · Docker**.
- 🌱 I aim to be a developer who **finishes services together with teammates**, rather than chasing perfect code alone.
...
| :--- | :--- | :--- | :--- |
| **Snack** | Organization-based purchasing & budget platform | NestJS · Prisma · MySQL · Redis · Docker · JWT | [Repo](https://github.com/BootCamp-Codeit/snack) · [Demo](https://snack-gray.vercel.app) |
| **Forest of Study** | Growth-record sharing study platform | Node.js · Express · Prisma · MySQL | [Repo](https://github.com/BootCamp-Codeit/forest-of-study) · [Demo](https://forest-of-study-mu.vercel.app/) |
| **Favorite Photo** | Photo-card trading & exchange platform | Next.js · React · Tailwind CSS | [Repo](https://github.com/BootCamp-Codeit/favorite-photo) · [Demo](https://favorite-photo-red.vercel.app/) |
