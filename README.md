...
`Backend Developer` · `BLOX 개발팀 연구원` · `2026.06 ~ 현재`
...
[![BLOX](https://img.shields.io/badge/BLOX.kr-D99A1C?style=for-the-badge&logo=googlechrome&logoColor=FBEFD3)](https://blox.kr/)
...
| | |
| :--- | :--- |
| 🏢 **현재** | [블록스(BLOX)](https://blox.kr/) 개발팀 연구원 — 엔터프라이즈 시스템 · AI 솔루션 개발 |
| 🔭 **전문 분야** | Node.js · NestJS 기반 REST API 설계 / DB 모델링 |
| 🛡️ **주요 경험** | Prisma 스키마 설계, JWT Guard 권한 분리, AuditLog, 예산 예약 트랜잭션 |
| ⚙️ **운영 환경** | GitHub Actions(CI) · E2E · AWS EC2 · PM2 · Docker |
| 👥 **협업** | Codeit 풀스택 10기 팀장 — 3개 프로젝트 리드 |
